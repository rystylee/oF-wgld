...
void ofApp::setup(){
    ...
    // load image
    img1.load("texture0.png");
    img2.load("texture1.png");
...
void ofApp::draw(){
    ...
    //pos * modelMatrix;
    plane.set(img1.getWidth(), -img1.getHeight());
    plane.mapTexCoordsFromTexture(img1.getTexture());
    ...
    shader.setUniformTexture("tex0", img1.getTexture(), 0);
    shader.setUniformTexture("tex1", img2.getTexture(), 1);
    ...
    img1.getTexture().unbind();
    img2.getTexture().unbind();
